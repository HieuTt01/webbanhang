<script type='text/javascript' src='<?php echo public_url('frontend')?>/tivi/jwplayer.js'></script>
<script type='text/javascript'>
jQuery('document').ready(function(){
	 jwplayer('mediaspace').setup({
    'flashplayer': '<?php echo public_url('frontend')?>/tivi/player.swf',
...
<!-- zoom image -->
<script src="<?php echo public_url()?>/frontend/jqzoom_ev/js/jquery.jqzoom-core.js" type="text/javascript"></script>
<link rel="stylesheet" href="<?php echo public_url()?>/frontend/jqzoom_ev/css/jquery.jqzoom.css" type="text/css">
<script type="text/javascript">
$(document).ready(function() {
	$('.jqzoom').jqzoom({
            zoomType: 'standard',
		           ...
		           <div class='product_view_content'>
		               ...
		               <p class='option'>
                          ...
                          <?php if($product->discount >0):?>
                               <?php $price_new = intval($product->price -($product->price* $product->discount /100));?>
		                ...
		                <p class='option'>
		                  Danh mục: 
		                  <a href="<?php echo base_url('product/catalog/'.$catalog->id)?>" title="<?php echo $product->name?>">
                       ...
                       <?php if($product->gift !=''):?>
		               <p class='option'>
		                  Tặng quà: <b><?php echo $product->gift?></b> 
		               </p>
                       <?php endif;?>              
		               Đánh giá &nbsp;
...
<!-- AddThis Button END -->
		            ...
		            <table width="100%" cellspacing="0" cellpadding="3" border="0" class="tbsicons">
					           <tbody>
					           <tr>
					                    <td width="25%"><img alt="Phục vụ chu đáo" src="<?php echo public_url('frontend')?>/images/icon-services.png"> <div>Phục vụ chu đáo</div></td>
					                    <td width="25%"><img alt="Giao hàng đúng hẹn" src="<?php echo public_url('frontend')?>/images/icon-shipping.png"><div>Giao hàng đúng hẹn</div></td>
					                    <td width="25%"><img alt="Đổi hàng trong 24h" src="<?php echo public_url('frontend')?>/images/icon-delivery.png"> <div>Đổi hàng trong 24h</div></td>
					           </tr>
					          </tbody>
					</table>
		      </div>

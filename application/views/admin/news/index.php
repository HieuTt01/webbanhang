...
<div class="wrapper" id="main_news">
    ...
    <div class="widget">
        ...
        <table cellpadding="0" cellspacing="0" width="100%" class="sTable mTable myTable" id="checkAll">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="item"><input name="id" value="<?php echo $this->input->get('id')?>"
                                                id="filter_id" type="text" style="width:55px;"></td>

                                        <td class="label" style="width:40px;"><label for="filter_id">Tiêu đề</label>
                                        </td>
                                        <td class="item" style="width:155px;"><input name="title"
                                                value="<?php echo $this->input->get('title')?>" id="filter_title"
            ...
            <thead>
                <tr>
                    <td style="width:21px;"><img src="<?php echo public_url('admin/images')?>/icons/tableArrows.png">
                    </td>
                    ...
                    <td colspan="6">
                        <div class="list_action itemActions">
                            <a href="#submit" id="submit" class="button blueB"
                                url="<?php echo admin_url('news/delete_all')?>">
            ...
            <tbody class="list_item">
                ...
                <tr class="row_<?php echo $row->id?>">
                    ...
                    <td>
                        ...
                        <div class="f11"> Xem: <?php echo $row->count_view?>
                        </div>
                    </td>
                    <td class="textC"><?php echo $row->created?></td>

                    <td class="option textC">
                        <a href="<?php echo base_url('news/view/'.$row->id)?>" target="_blank" class="tipS"
                        ...
                        <a href="<?php echo admin_url('news/delete/'.$row->id)?>" title="Xóa"

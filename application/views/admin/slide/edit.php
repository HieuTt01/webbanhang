            ...
            <div class="tab_container">
               <div id="tab1" class="tab_content pd0">
                  <div class="formRow">
                     ...
                     <div class="formRight">
                        <span class="oneTwo"><input value="<?php echo $slide->name?>" name="name" id="param_name" _autocheck="true" type="text"></span>
                  ...
                  <div class="formRow">
                     ...
                     <div class="formRight">
                        <div class="left">
                           ...
                           <img src="<?php echo base_url('upload/slide/'.$slide->image_link)?>" alt="" style="weidtth:100px;height:70px " >
                        </div>
